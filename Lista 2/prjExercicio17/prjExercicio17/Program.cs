...
namespace prjExercicio17
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.Write("Insira um outro número, que seja diferente de " + n1.ToString() + ": ");
            n2 = int.Parse(Console.ReadLine());
            Console.Write("Insira mais um número, que seja diferente de " +n1.ToString() + " e de " +n2.ToString() + ": ");
